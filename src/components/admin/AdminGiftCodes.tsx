  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <KPICard icon={<Gift />} label="Total Criados" value={stats.total} />
        <KPICard icon={<Check />} label="Ativos" value={stats.active} accent="text-primary" />
        <KPICard icon={<Users />} label="Resgatados" value={stats.redeemed} accent="text-[#8B6A30]" />
        <KPICard icon={<Ban />} label="Esgotados" value={stats.exhausted} accent="text-red-600" />
      </div>
