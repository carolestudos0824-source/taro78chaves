...
const GlobalMenu = ({ isOpen, onClose }: GlobalMenuProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex animate-in fade-in duration-300">
      ...
      {/* Drawer */}
      <div className="fixed top-0 left-0 w-[320px] max-w-[85vw] h-full bg-[#FDFBF7] shadow-2xl flex flex-col border-r-2 border-[#C8A66A]/20 animate-in slide-in-from-left duration-500 overflow-hidden z-[110]">
        {/* Header */}
