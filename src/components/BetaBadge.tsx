const BetaBadge = () => (
  <div
    className="fixed top-2 left-1/2 -translate-x-1/2 z-50 flex items-center gap-1.5 px-3 py-1 rounded-full select-none pointer-events-none md:top-auto md:bottom-20 md:right-3 md:left-auto md:translate-x-0"
    style={{
