          ...
          return (
            <div className="text-center py-10 space-y-6">
              ...
              <div className="flex justify-center gap-6">
                ...
                <div className="text-center">
                  <span className="block font-heading text-xl" style={{ color: `hsl(${accent})` }}>100%</span>
                  <span className="text-[9px] font-heading tracking-[0.2em] uppercase" style={{ color: "hsl(230 10% 50%)" }}>Domínio</span>
                </div>
              </div>
