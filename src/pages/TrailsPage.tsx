...
const TrailsPage = () => {
  ...
  return (
    <div className="relative w-full max-w-full flex flex-col items-center overflow-x-hidden box-border" id="trails-page-root" style={{ minHeight: '100vh', background: '#FAF5EF' }}>
      ...
      <div className="relative w-full max-w-2xl px-4 sm:px-6 pt-6 sm:pt-12 pb-8 box-border flex flex-col items-center">
        ...
        <div className="absolute top-0 right-0 w-full overflow-visible h-32 sm:h-48 pointer-events-none z-0">
          <div className="flex justify-end items-start pt-2 sm:pt-6 pr-4 sm:pr-12">
            <div className="flex -space-x-12 sm:-space-x-16">
              <img 
                src={imgLouco} 
                alt="" 
                className="w-16 h-24 sm:w-28 sm:h-44 object-cover rounded-xl border-2 border-[#C8A66A]/40 -rotate-[12deg] shadow-[0_10px_30px_rgba(0,0,0,0.15)] opacity-80" 
              />
              <img 
                src={imgMago} 
                alt="" 
                className="w-16 h-24 sm:w-28 sm:h-44 object-cover rounded-xl border-2 border-[#C8A66A]/40 rotate-[8deg] shadow-[0_10px_30px_rgba(0,0,0,0.15)] opacity-95 relative z-10" 
              />
            </div>
          </div>
        </div>

        <div className="text-center relative z-10 w-full mt-4 sm:mt-8">
