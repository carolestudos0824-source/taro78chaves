...
const TrailsPage = () => {
  ...
  return (
    <div className="relative w-full flex flex-col items-center" style={{ minHeight: '100vh', background: '#FDFBF7' }}>
      ...
      <div className="relative w-full max-w-2xl px-4 sm:px-6 pb-24 space-y-6 box-border">
