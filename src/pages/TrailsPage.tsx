...
const TrailsPage = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-[#FAF5EF] pb-[calc(112px+env(safe-area-inset-bottom))] font-body text-[#5B1F3D] overflow-x-hidden scroll-pb-[calc(112px+env(safe-area-inset-bottom))]">
      ...
      <div className="relative max-w-2xl mx-auto px-6 pt-6 sm:pt-24 flex flex-col items-center">
        {/* Header Section - Enhanced Spacing & Ritualistic feel */}
        <div className="text-center mb-4 relative w-full px-4">
        ...
        <div className="w-full bg-white/95 backdrop-blur-xl p-8 sm:p-12 rounded-[3rem] border border-[#C8A66A4D] shadow-[0_30px_70px_rgba(91,31,61,0.08)] mb-6 sm:mb-12 relative overflow-hidden group transition-all duration-500 hover:shadow-[0_40px_80px_rgba(91,31,61,0.12)]">
        ...
        <div className="w-full relative space-y-12 sm:space-y-36">
          ...
          {TRAIL_LEVELS.map((level, i) => {
            ...
            return (
              <div key={level.id} className="relative group transition-all duration-700">
                ...
                <div className="flex items-center gap-7 sm:gap-12 mb-6 sm:mb-16 relative z-10">
