...
const DailyChallengesPage = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden pb-bottom-nav bg-[#FAF5EF]" id="ritual-page-root" style={{ scrollBehavior: 'smooth' }}>
      ...
      <div className="relative z-10 max-w-lg mx-auto px-4 md:px-6 pb-[calc(180px+env(safe-area-inset-bottom))] space-y-10 pt-4 md:mt-12 overflow-y-auto">
