...
import { validateArcano, createEmptyArcano, editorialToLegacy } from "./_editorial";
...
export {
  ...
  OS_ENAMORADOS, O_CARRO, A_FORCA, O_EREMITA, A_RODA_DA_FORTUNA, A_JUSTICA,
  O_ENFORCADO, A_MORTE, A_TEMPERANCA, O_DIABO, A_TORRE, A_ESTRELA,
  A_LUA, O_SOL, O_JULGAMENTO, O_MUNDO,
};
export { validateArcano, createEmptyArcano, editorialToLegacy } from "./_editorial";
export type { ArcanoMaiorEditorial } from "./_editorial";
