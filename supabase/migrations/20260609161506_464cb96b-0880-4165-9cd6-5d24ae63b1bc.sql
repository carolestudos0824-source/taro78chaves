-- 1. Recriar complete_lesson_v2 com validação segura de existência
...
DECLARE
    ...
    _progress_exists boolean := false;
BEGIN
    _user_id := auth.uid();
    ...
    -- Validação Segura de Existência
    IF _progress_exists IS NOT TRUE THEN
    ...
    -- Validar contra o catálogo real
...
-- 2. Recriar complete_module_v2 com validação segura de existência e lições obrigatórias
